...
database.db-path=/group/calviello/Roberto/R2T2P_DUX4_test/fragpipe/2025-05-10-decoys-contam-annot_and_orfquant_proteins_db.fasta.fas
...
tmtintegrator.ref_tag=Reference
...
workflow.description=<p style\="margin-top\: 0">Basic TMT 16-plex workflow, with quantification and identification from MS2. Met oxidation, protein N-term Acetyl, n-term TMT are specified as variable modifications. TMT-Integrator with reference approach, no normalization, no log2 transformation, data summarization at all levels. The reference/bridge channel name tag is specified in the annotation file(s) and in TMT-Integrator tab.</p>
